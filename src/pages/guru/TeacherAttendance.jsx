...
const TeacherAttendance = () => {
  ...
  useEffect(() => {
    if (!selectedClass || !selectedDate || !userData?.school_id || students.length === 0) return;
  ...
  const saveAttendance = async () => {
    ...
    try {
      ...
      for (const studentId in attendance) {
        ...
        const existingAttendance = await firestoreService.getDocument('attendance', attendanceId);
